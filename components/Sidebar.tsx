...
const CogIcon: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0115 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5" /></svg>;
...
const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, userProfile, trades, selectedDate, onDateSelect, tradingPlan }) => {
    const navItems = [
    ...
    return (
        <aside className="bg-[#0c1322]/80 border-r border-border-color flex flex-col p-3 md:p-4 space-y-4 overflow-y-auto">
            ...
            <div className="hidden md:block">
                <Calendar trades={trades} selectedDate={selectedDate} onDateSelect={onDateSelect} isMini={true}/>
            </div>
